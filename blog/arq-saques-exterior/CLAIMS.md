...
O ajuste cambial do ARQ começa em zero e deve ser preenchido com a diferença observada na cotação ou no débito liquidado.
...
- Revolut: inserir somente quando o URL exato de indicação estiver registrado. Não substituir por URL genérica como se fosse afiliada.
